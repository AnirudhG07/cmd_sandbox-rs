...
// This module handles cgroup creation, configuration, and cleanup for resource limiting
...
/// Setup cgroup with memory and CPU limits from configuration
...
/// Cleanup cgroup on program exit
...
/// Move a process to the sandbox cgroup
