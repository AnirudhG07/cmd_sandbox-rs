...
We use Aya-rs which is eBPF, but in Rust, and why not use Rust because of its memory safety, amazing coding experience and I know Rust more than C, LOL!
...
- **SEC-EXTRA**: Block Dangerous Loader Variables - Filter LD_PRELOAD and LD_LIBRARY_PATH
